...
export function AiGlobe({ size = 320, className }: AiGlobeProps) {
  return (
    <div
      className={`relative flex items-center justify-center select-none pointer-events-none${className ? ` ${className}` : ""}`}
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          boxShadow:
            "inset -12px -12px 32px rgba(0,0,0,0.8), inset 6px 6px 20px rgba(220,190,255,0.25), 0 0 40px rgba(130,90,255,0.2)",
          zIndex: 1,
        }}
      >
